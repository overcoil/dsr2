...
package io.delta.standalone.types; // cribbed from org.apache.iceberg
...
public interface Type extends Serializable {
  ...
  default io.delta.standalone.types.Types.StructType asStructType() {
    throw new IllegalArgumentException("Not a struct type: " + this);
  }

  default io.delta.standalone.types.Types.ListType asListType() {
    throw new IllegalArgumentException("Not a list type: " + this);
  }

  default io.delta.standalone.types.Types.MapType asMapType() {
  ...
  abstract class PrimitiveType implements Type {
    ...
    Object writeReplace() throws ObjectStreamException {
      return new io.delta.standalone.types.PrimitiveHolder(toString());
    }
  }
  ...
  abstract class NestedType implements Type {
    ...
    public abstract List<io.delta.standalone.types.Types.NestedField> fields();

    public abstract Type fieldType(String name);

    public abstract io.delta.standalone.types.Types.NestedField field(int id);
  }
